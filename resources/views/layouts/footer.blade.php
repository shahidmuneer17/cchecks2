<footer class="footer">
  <div class="row g-0 justify-content-between fs-10 mt-4 mb-3">
    <div class="col-12 col-sm-auto text-center">
      <p class="mb-0 text-600">cChecks - Seminole Wireless LLC <span class="d-none d-sm-inline-block">| </span><br class="d-sm-none" /> 2024 &copy; <a href="https://semcel.com">Seminole Wireless</a></p>
    </div>
    <div class="col-12 col-sm-auto text-center">
    ...
    <div class="modal-content border-0">
      <div class="modal-header px-5 position-relative modal-shape-header bg-shape">
        <div class="position-relative z-1">
          ...
          <p class="fs-10 mb-0 text-white">Please create your cChecks account</p>
        </div>
      ...
      <div class="modal-body py-4 px-5">
        ...
        <!--
                ...
                <div class="row g-2 mt-2">
                  <div class="col-sm-6"><a class="btn btn-outline-google-plus btn-sm d-block w-100" href="#"><span class="fab fa-google-plus-g me-2" data-fa-transform="grow-8"></span> noogle</a></div>
